...
\section{Testing}
For testing our compiler, we chose for pytest. We have 50 test programs, where each program tests one encapsulated part of functionality. These tests also include several death tests.
